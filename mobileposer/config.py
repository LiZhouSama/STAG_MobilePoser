...
class paths:
    ...
    body_model_file = "/mnt/d/a_WORK/Projects/PhD/datasets/smpl_models/smplh/male/model.npz"
    weights_file = root_dir / "mobileposer" / "checkpoints" / "weights.pth"
    raw_amass = Path("/mnt/d/a_WORK/Projects/PhD/datasets/AMASS_SMPL_H")           # TODO: replace with your path
    raw_dip = Path("/mnt/d/a_WORK/Projects/PhD/datasets/DIP/DIP_IMU")           # TODO: replace with your path
